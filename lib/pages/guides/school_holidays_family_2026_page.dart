    ...
    return ValueListenableBuilder<AppLanguage>(
      ...
      builder: (context, language, _) {
        ...
        return ContentPageScaffold(
          ...
          afterSections: _SchoolGuideSources(language: language),
        );
      },
    );
  }
...
class _SchoolGuideSources extends StatelessWidget {
  const _SchoolGuideSources({required this.language});
  ...
  Widget build(BuildContext context) {
    final items = [
      (
        'education.gouv.fr',
        isEnglish ? 'Official school calendar' : 'Calendrier scolaire officiel',
        'https://www.education.gouv.fr/calendrier-scolaire-100148',
      ),
      (
        'data.gouv.fr',
        isEnglish
            ? 'Source of school holiday periods shown on this page'
            : 'Source des périodes scolaires affichées sur cette page',
        'https://www.data.gouv.fr/fr/dataservices/api-calendrier-scolaire/',
      ),
    ];
